...
<!-- CTA -->
<div class="col-lg-5 mt-4 bg-white bg-opacity-25 p-4 rounded text-center">
  <p class="fw-bold text-danger">Get started with us today!</p>
  ...
  <!-- Login Button -->
  <a href="forms/login.php" class="btn btn-outline-light w-100 mt-3">Login</a>
</div>
